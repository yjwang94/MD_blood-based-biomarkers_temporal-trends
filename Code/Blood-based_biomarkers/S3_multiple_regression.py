...
target = 'Depression'
dpath = '/data/CaseControl/'
target_yrs = 'BL2' + target + '_yrs'
outpath = '/data/CaseControl/' + target
f_df = pd.read_csv('/data/PhenoData/Feature_Dict.csv')
f_category = pd.read_csv('/data/PhenoData/feat_catorgy.csv')
