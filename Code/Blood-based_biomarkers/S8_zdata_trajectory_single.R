...
MD = "DEP"
UKB_pheno = read.csv("/Users/yujia/Desktop/a/project/Evolution/MD/Data/PhenoData/PhenoData2Analysis/UKB_pheno.csv")
UKB_blood_dict = read.csv("/Users/yujia/Desktop/a/project/Evolution/MD/Data/PhenoData/PhenoData2Analysis/UKB_Blood_dict.csv")
NMR_dict = read.csv("/Users/yujia/Desktop/a/project/Evolution/MD/MD_prepost/abbreviation_NMR.csv")
Serum_dict = read.csv("/Users/yujia/Desktop/a/project/Evolution/MD/MD_prepost/Serum_dict1.csv")
...
zdata = read.csv(paste("/Users/yujia/Desktop/a/project/Evolution/MD/MD1205/", MD, '/S4_zdata.csv',sep = ''))
...
setwd(paste("/Users/yujia/Desktop/a/project/Evolution/MD/MD1205/",MD,"/trend_cluster_single/",sep = ''))
...
for (i in c(48:length(colnames(zdata)))) {
  zdata_plot_cluster = zdata[c("duration",colnames(zdata)[i])]
  ...
  zdata_plot_melt = zdata_plot_cluster[complete.cases(zdata_plot_cluster[,2]),]
  colnames(zdata_plot_melt)[2] = "Field"
  p_cluster <- ggplot() +
    #geom_line(stat="smooth", data=zdata_plot_melt, aes(x=duration, y=value, group=variable),method = 'loess', span = 2,se = FALSE,linewidth = 1, color = color[i],alpha = 0.4) +
    labs(x="Years to Diagnosis", y=colnames(zdata_plot_cluster)[2]) +
  ...
  #修改配色
  #p_cluster
  ggsave(paste(colnames(zdata_plot_cluster)[2], ".pdf",sep = ""))
}
