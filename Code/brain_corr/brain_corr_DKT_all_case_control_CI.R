...
colnames(betas_all)[23] = "Glucose"
colnames(pvalues_all)[23] = "Glucose"
colnames(low_CI_all)[23] = "Glucose"
colnames(up_CI_all)[23] = "Glucose"
...
ggsave(paste("DKT_all_sig_new.pdf",sep = ""),width = 15,height = 12)
